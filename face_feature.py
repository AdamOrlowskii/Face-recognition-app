...
config_file = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'config', 'model_conf.yaml'))
...
def gui(path_to_file):
    if __name__ == '__main__':
        ...
        # read image
        image_path = 'test_images/adam_cropped.jpg'
        ...
        np.save('test_images/testowanie.npy', feature)
...
if __name__ == '__main__':
    ...
    np.save('test_images/adam_feature.npy', feature)
