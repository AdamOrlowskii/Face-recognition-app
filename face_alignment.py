...
def gui(path_to_file_jpg, path_to_file_txt):
    with open('../config/model_conf.yaml') as f:
        ...
        # read image
        #path_to_file_jpg = 'test_images/testowanie.jpg'
        #path_to_file_txt = 'test_images/testowanie.txt'
        image = cv2.imread(path_to_file_jpg, cv2.IMREAD_COLOR)
        ...
        try:
            for i, line in enumerate(lines):
                ...
                save_path_img = 'test_images/testowanie_' + 'landmark_res' + str(i) + '.jpg'
                save_path_txt = 'test_images/testowanie_' + 'landmark_res' + str(i) + '.txt'
...
#     image_det_txt_path = 'test_images/adam_detect_res.txt'
...
#             save_path_img = 'test_images/adam_' + 'landmark_res' + str(i) + '.jpg'
#             save_path_txt = 'test_images/adam_' + 'landmark_res' + str(i) + '.txt'
#             image_show = image.copy()
#             with open(save_path_txt, "w") as fd:
#                 for (x, y) in landmarks.astype(np.int32):
#                     cv2.circle(image_show, (x, y), 2, (255, 0, 0),-1)
