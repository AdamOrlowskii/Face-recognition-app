...
def gui(path_to_file):
    ...
    with open('../config/model_conf.yaml') as f:
        ...
        # gen result
        save_path_img = 'test_images/testowannie_detect.jpg'
        save_path_txt = 'test_images/testowanie_res.txt'
        ...
        return (save_path_img, save_path_txt)
...
if __name__ == '__main__':
    ...
    # gen result
    save_path_img = 'test_images/adam_detect_res.jpg'
    save_path_txt = 'test_images/adam_detect_res.txt'
